...
const Footer = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.1" className=' w-full h-screen bg-[#f1f1f1] p-20 border-t-[1px] border-zinc-200 rounded-tr-3xl rounded-tl-3xl flex '>
      <div className='w-1/2 h-full flex flex-col justify-between' >
       <div className=' heading'>
       <h1 className=' text-[7vw] uppercase tracking-tighter font-semibold -mb-10 '> eye</h1>
       <h1 className='text-[7vw] uppercase tracking-tighter font-semibold'>opening</h1>
       </div>
      ...
      <div className=' w-1/2'>
      <h1 className=' text-[7vw] uppercase tracking-tighter font-semibold -mb-10 '> presentation</h1>
   
       <div className="details mt-5 " >
        <span className=' inline-block text-xl mb-3 '>S :</span>
       ...
       <div className="details mt-5 " >
        <span className=' inline-block text-xl mb-3 '>L :</span>
        <a className=' block text-xl font-light underline' href="#">202-1965 w 5th Ave</a>
        <a className='  block text-xl font-light underline' href="#">Vancouver,Canada</a>
        <a className='  block text-xl font-light underline mt-3' href="#">30 Chukarina St</a>
        <a className='  block text-xl font-light underline' href="#">Lviv,Ukraine </a>
       </div>
       
       <div className="mail mt-5" >
      <span className=' inline-block text-xl mb-3 '>m :</span>
      <a className=' block text-xl font-light underline' href="#">hello@ochi.design</a>
      </div>
